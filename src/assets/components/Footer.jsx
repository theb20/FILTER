        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="text-dark">
              <h4 className="font-semibold text-dark mb-4">Légal</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-amber-600 transition-colors">Mentions légales</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">CGV</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">CGU</a></li>
                <li><a href="#" className="hover:text-amber-600 transition-colors">Politique de cookies</a></li>
              </ul>
            </div>
            <div className="text-dark">
            ...
            <div>
              <h4 className="font-semibold text-dark mb-4">Suivez-nous</h4>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center text-dark gap-4 text-sm">
              ...
              <span className="text-gray-700">•</span>
              <a href="#" className="hover:text-amber-600 transition-colors">Paramètres</a>
            </div>
          </div>
        </div>
      </footer>
